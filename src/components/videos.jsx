        ...
        <div className="demoVideoSection">
            ...
            <div className="demoVideos">
                <div className="first-video" id="video">                 
                    ...
                    <a href="https://github.com/jeffkim1118/game-deals-watcher" target="_blank" rel="noreferrer" type="button" class="btn btn-primary">Github</a>
                </div>
                <div className="second-video" id="video">    
                    ...
                    <a href="https://github.com/jeffkim1118/blog-website" target="_blank" rel="noreferrer" type="button" class="btn btn-primary">Github</a>
                </div>
                <div className="third-video" id="video">               
                    ...
                    <a href="https://github.com/jeffkim1118/EZ-Weather" target="_blank" rel="noreferrer" type="button" class="btn btn-primary">Github</a>
                </div>
            </div>
        </div>
    )
